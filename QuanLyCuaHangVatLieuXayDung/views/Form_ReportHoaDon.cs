...
namespace QuanLyCuaHangVatLieuXayDung.views
{
    public partial class Form_ReportHoaDon : Form
    {
        ...
        private void Form_ReportHoaDon_Load(object sender, EventArgs e)
        {
            ...
            if (this.hoaDon is HoaDonXuat)
            {
                this.InHoDonXuat((HoaDonXuat)this.hoaDon);
            }
            //else if (this.hoaDon is HoaDonNhap)
            //{
        ...
        private void InHoDonXuat(HoaDonXuat hoaDonXuat)
        {
            ...
            ReportParameter rp15 = new ReportParameter("NoCu", this.stringUtility.ConvertToVietnameseCurrency(1000000));
            ReportParameter rp16 = new ReportParameter("TongTienHoaDon", this.stringUtility.ConvertToVietnameseCurrency(hoaDonXuat.tinhTongTien()));
            this.reportViewerHoaDon.LocalReport.SetParameters(new ReportParameter[] { rp, rp1, rp2, rp3, rp4, rp5, rp6, rp7, rp8, rp9, rp10, rp11, rp12, rp13, rp14, rp15, rp16});
